    ...
    return (
        <header className="h-16 flex items-center backdrop-blur-lg w-full fixed px-4 relative">
            <div className="flex gap-3 items-center">
                <FontAwesomeIcon className={`${theme?"text-stone-300":"text-stone-800"} cursor-pointer`} onClick={()=>navigate("/")} icon={faArrowLeft}/>
            ...
            <div className={`flex gap-3 absolute right-5 ${theme?"text-stone-400":"text-stone-600"}`}>
